...
| Merchant Federation | Build commerce routes and arbitrate economic power. | gains from contracts, trade defense, market events. | bags, mounts, recipes, tax reductions. | auctioneers, caravan masters. | Clerk, Factor, Trade Broker, Magnate, Trade Prince |
